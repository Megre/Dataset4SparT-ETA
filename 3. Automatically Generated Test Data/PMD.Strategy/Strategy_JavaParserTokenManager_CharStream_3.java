...
public class Strategy_JavaParserTokenManager_CharStream_3
{
	public static void main(String[] args) throws java.lang.Exception {
		...
		net.sourceforge.pmd.ast.JavaParserTokenManager context = new net.sourceforge.pmd.ast.JavaParserTokenManager(strategy, 1);		
