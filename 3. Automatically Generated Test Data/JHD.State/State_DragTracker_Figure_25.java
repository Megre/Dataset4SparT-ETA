...
public class State_DragTracker_Figure_25
{
	public static void main(String[] args) throws java.lang.Exception {
		...
		CH.ifa.draw.standard.DragTracker context = new CH.ifa.draw.standard.DragTracker(new CH.ifa.draw.standard.StandardDrawingView(new CH.ifa.draw.application.DrawApplication("test"), 1, 1), state);
