...
public class Strategy_Setter_StandardDrawingView_Drawing_296
{
	public static void main(String[] args) throws java.lang.Exception {
		...
		context.add(new CH.ifa.draw.figures.ImageFigure(new java.awt.image.BufferedImage(1, 1, java.awt.image.BufferedImage.TYPE_3BYTE_BGR), "test", new java.awt.Point()));
	}
} 
