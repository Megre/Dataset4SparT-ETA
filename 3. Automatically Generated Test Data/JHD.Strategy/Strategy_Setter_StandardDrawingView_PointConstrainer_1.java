...
public class Strategy_Setter_StandardDrawingView_PointConstrainer_1
{
	public static void main(String[] args) throws java.lang.Exception {
		...
		context.mouseReleased(new java.awt.event.MouseEvent(new java.awt.Button(), java.awt.event.MouseEvent.MOUSE_CLICKED, 1, java.awt.event.InputEvent.SHIFT_DOWN_MASK, 1, 1, 1, false));
	}
} 
