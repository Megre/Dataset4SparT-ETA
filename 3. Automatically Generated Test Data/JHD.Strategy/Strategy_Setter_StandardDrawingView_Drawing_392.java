...
public class Strategy_Setter_StandardDrawingView_Drawing_392
{
	public static void main(String[] args) throws java.lang.Exception {
		...
		context.remove(new CH.ifa.draw.figures.EllipseFigure(new java.awt.Point(), new java.awt.Point()));
	}
} 
