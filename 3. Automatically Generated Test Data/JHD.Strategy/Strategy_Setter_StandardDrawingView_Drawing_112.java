...
public class Strategy_Setter_StandardDrawingView_Drawing_112
{
	public static void main(String[] args) throws java.lang.Exception {
		...
		context.remove(new CH.ifa.draw.samples.javadraw.PatternPainter(new java.awt.image.BufferedImage(1, 1, java.awt.image.BufferedImage.TYPE_3BYTE_BGR)));
	}
} 
