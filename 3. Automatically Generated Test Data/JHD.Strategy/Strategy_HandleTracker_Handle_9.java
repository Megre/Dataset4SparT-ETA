...
public class Strategy_HandleTracker_Handle_9
{
	public static void main(String[] args) throws java.lang.Exception {
		...
		context.mouseUp(new java.awt.event.MouseEvent(new java.awt.Button(), java.awt.event.MouseEvent.MOUSE_CLICKED, 1, java.awt.event.InputEvent.SHIFT_DOWN_MASK, 1, 1, 1, false), 1, 1);
	}
}
