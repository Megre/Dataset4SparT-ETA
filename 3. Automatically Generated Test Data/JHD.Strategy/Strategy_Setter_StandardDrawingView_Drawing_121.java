...
public class Strategy_Setter_StandardDrawingView_Drawing_121
{
	public static void main(String[] args) throws java.lang.Exception {
		...
		context.remove(new CH.ifa.draw.contrib.DiamondFigure(new java.awt.Point(), new java.awt.Point()));
	}
} 
